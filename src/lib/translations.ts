export const translations = {
  en: {
    ...
    'wizard.restartWarning.description': "Careful! If you restart, your plan content will be lost. One credit has already been consumed from your balance for this conversation because it reached the final phase.",
    'wizard.restartWarning.confirm': 'Yes, restart',
    'wizard.creditConsumedInPlan': '1 plan was used from your balance for this conversation.',
  ...
  es: {
    ...
    'wizard.readyToBuild': "Vamos a construir tu plan. Tengo tu objetivo en mente.",
    ...
    'wizard.restartWarning.description': '¡Cuidado! Si reinicias tu plan se perderá el contenido y ya se consumió un crédito de tu balance en esta conversación porque llegó a la fase final.',
    'wizard.restartWarning.confirm': 'Sí, reiniciar',
    'wizard.creditConsumedInPlan': 'Se consumió 1 plan de tu balance en esta conversación.',
  ...
  pt: {
    ...
    'wizard.restartWarning.description': 'Cuidado! Se reiniciar, o conteúdo do seu plano será perdido e um crédito já foi consumido do seu saldo nesta conversa porque chegou à fase final.',
    'wizard.restartWarning.confirm': 'Sim, reiniciar',
    'wizard.creditConsumedInPlan': '1 plano foi usado do seu saldo nesta conversa.',
  ...
  fr: {
    ...
    'wizard.restartWarning.description': 'Attention ! Si vous réinitialisez, le contenu de votre plan sera perdu et un crédit a déjà été consommé de votre solde pour cette conversation car elle a atteint la phase finale.',
    'wizard.restartWarning.confirm': 'Oui, réinitialiser',
    'wizard.creditConsumedInPlan': '1 plan a été utilisé de votre solde pour cette conversation.',
  ...
  de: {
    ...
    'wizard.restartWarning.description': 'Achtung! Wenn Sie neu starten, geht der Planinhalt verloren und ein Guthaben wurde bereits für dieses Gespräch verbraucht, da die Endphase erreicht wurde.',
    'wizard.restartWarning.confirm': 'Ja, neu starten',
    'wizard.creditConsumedInPlan': '1 Plan wurde von Ihrem Guthaben für dieses Gespräch verwendet.',
