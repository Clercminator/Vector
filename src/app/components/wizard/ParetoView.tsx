...
const ParetoList = ({
  ...
  return (
    <div
      className={`p-8 md:p-10 rounded-[2.5rem] border relative overflow-hidden flex flex-col h-full transition-all duration-500 ${
        isVital
...
export const ParetoView: React.FC<ParetoViewProps> = ({
  ...
  return (
    <div className="mt-8 w-full max-w-[90rem] mx-auto px-4">
      {isMobile && (
        <DesktopRecommendedBanner className="mb-8 max-w-6xl mx-auto" />
      )}
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <div className="flex h-8 rounded-full overflow-hidden border border-gray-200 dark:border-zinc-700 shadow-inner w-40 bg-gray-100 dark:bg-zinc-800">
              ...
              <div
                ...
                title={`${trivialCount} lower impact`}
              >
                {trivialCount > 0 && (
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            <span className="font-semibold text-blue-600 dark:text-blue-400">
              {replaceValue("pareto.highImpactCount", String(vitalCount))}
            </span>
            {trivialCount > 0 && (
              <>
      ...
      <div className="grid lg:grid-cols-[1.3fr_1fr] gap-8 w-full max-w-6xl mx-auto items-start">
        ...
        >
          <ParetoList
            ...
            subtitle={t("pareto.subtitleVital")}
            items={result.vital || []}
        ...
        >
          <ParetoList
            ...
            subtitle={t("pareto.subtitleTrivial")}
