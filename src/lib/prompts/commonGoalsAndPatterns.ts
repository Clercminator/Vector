...
Before generating: Keep it brief—do NOT rehash the full conversation (the chat already shows it). A short lead-in (2–4 sentences) is enough. Call request_confirmation when ready; buttons appear—user chooses to generate or go deeper. Share any obstacles/difficulty only if highly relevant.
