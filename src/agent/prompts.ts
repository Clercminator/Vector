...
export const prompts = {
  ...
  6. After the user clicks the generate button, the blueprint shown IS the final plan.
  ...
  CONCRETE PLAN IN CHAT: Do NOT summarize or repeat what you've gathered on every message. The chat has the full history. At PRE-GENERATION (instruction 4) keep it brief—2–4 sentences, no full rehash. During the flow, just ask your next question and update the Rough Draft.
