...
**Current payments:** Vector uses **MercadoPago** (LATAM) and **Lemon Squeezy** (global). See [integrations README](../../README.md) and the main [README](../../../README.md) (Backend, Edge Functions) for the active payment flow.
