...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const featuredGuides = frameworkGuides.slice(0, 3);
  ...
  const frameworksList = frameworks.map((f) => ({
    ...
    pros:
      [0, 1, 2].map((i) => t(`fw.${f.id}.pros.${i}`)).filter(Boolean).length > 0
        ? [0, 1, 2].map((i) => t(`fw.${f.id}.pros.${i}`))
        : f.pros,
    cons:
      [0, 1, 2].map((i) => t(`fw.${f.id}.cons.${i}`)).filter(Boolean).length > 0
  ...
  return (
    ...
    >
      ...
      <section className="px-6 pt-12 pb-16 md:pt-14 md:pb-20 text-center max-w-5xl md:max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.button
              onClick={() => {
                trackClick("hero_help_me_plan");
                (onHeroGetStarted ?? onShowHelpChoose)();
              }}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="inline-block px-5 py-3 rounded-2xl bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-100/80 dark:border-indigo-900/40 max-w-2xl mx-auto">
              <h3 className="font-semibold text-indigo-900 dark:text-indigo-200 mb-1">
                {t("landing.whatIsVector.title")}
              </h3>
              <p className="text-sm text-indigo-700/90 dark:text-indigo-300/90 leading-relaxed">
                {t("landing.whatIsVector.desc")}
              </p>
            </div>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              ...
              const hoverRing =
                step === 1
                  ? "hover:shadow-blue-500/15 hover:ring-blue-500/25 dark:hover:shadow-blue-400/10 dark:hover:ring-blue-400/20"
                  : step === 2
                    ? "hover:shadow-amber-500/15 hover:ring-amber-500/25 dark:hover:shadow-amber-400/10 dark:hover:ring-amber-400/20"
                    : step === 3
                      ? "hover:shadow-emerald-500/15 hover:ring-emerald-500/25 dark:hover:shadow-emerald-400/10 dark:hover:ring-emerald-400/20"
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <span className="text-gray-800 dark:text-gray-200 leading-relaxed">
                      {t("landing.howItWorks.examples.actionable1")}
                    </span>
                  </div>
                </div>
                <div className="space-y-2 pt-4 border-t border-indigo-200/50 dark:border-indigo-800/30">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    />
                    <span className="text-gray-800 dark:text-gray-200 leading-relaxed">
                      {t("landing.howItWorks.examples.actionable2")}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 auto-rows-[minmax(200px,auto)]">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                    {t("landing.advantage.livingPlan.title")}
                  </h3>
                  <p className="text-indigo-900/70 dark:text-indigo-200/70 text-lg leading-relaxed max-w-lg">
                    {t("landing.advantage.livingPlan.desc")}
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col h-full justify-between text-white dark:text-black">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-3">
                    {t("landing.advantage.quality.title")}
                  </h3>
                  <p className="text-white/70 dark:text-black/70 leading-relaxed text-base">
                    {t("landing.advantage.quality.desc")}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                    {t("landing.advantage.execution.title")}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-base">
                    {t("landing.advantage.execution.desc")}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                    {t("landing.advantage.noPrompting.title")}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-base">
                    {t("landing.advantage.noPrompting.desc")}
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                    {t("landing.advantage.community.title")}
                  </h3>
                  <p className="text-amber-900/70 dark:text-amber-200/70 leading-relaxed text-base">
                    {t("landing.advantage.community.desc")}
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="px-6 py-24 bg-gray-50/30 dark:bg-zinc-900/30 backdrop-blur-sm border-t border-gray-100 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <motion.button
              onClick={() => {
                trackClick("frameworks_help_me_choose");
                onShowHelpChoose();
              }}
          ...
          <div className="mt-12 grid gap-6 rounded-[2rem] border border-zinc-200/80 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950/70 lg:grid-cols-[minmax(0,1fr)_minmax(340px,0.9fr)]">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-zinc-500 dark:text-zinc-400">
                {t("landing.guides.explore")}
              </p>
              <h3 className="mt-4 text-3xl font-bold tracking-tight text-zinc-950 dark:text-white">
              ...
              {featuredGuides.map((guide) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
                    {guide.readingTime} · {guide.keywords[0]}
                  </p>
                  <span
      ...
      <section className="px-6 py-40 text-center overflow-hidden">
        ...
        >
          <p className="text-xl md:text-2xl font-light text-gray-400 mb-6 uppercase tracking-[0.4em]">
            {t("footer.liftoff")}
          </p>
