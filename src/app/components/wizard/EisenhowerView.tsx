...
const Quadrant = ({
  ...
  return (
    <div
      className={`p-6 rounded-[2rem] border relative overflow-hidden flex flex-col h-full transition-all hover:shadow-xl ${colorClass}`}
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-6">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            {icon}
            <h4 className="font-bold text-lg uppercase tracking-wide opacity-90">
              {title}
            </h4>
          </div>
        ...
        <button
          ...
          title={t("common.copyList")}
          aria-label={t("common.copyList")}
        >
          <Copy size={18} />
        </button>
      </div>
    ...
    <div className="mt-8 w-full max-w-[90rem] mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 p-4 md:p-8 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-3xl rounded-[3rem] border border-white/40 dark:border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <Quadrant
          ...
          icon={
            <span className="w-10 h-10 rounded-2xl bg-red-100 dark:bg-red-500/20 flex items-center justify-center text-red-600 dark:text-red-400 shadow-sm">
        ...
        <Quadrant
          ...
          icon={
            <span className="w-10 h-10 rounded-2xl bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-sm">
              <Clock size={20} className="fill-current" />
            </span>
          }
        ...
        <Quadrant
          ...
          icon={
            <span className="w-10 h-10 rounded-2xl bg-amber-100 dark:bg-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400 shadow-sm">
        ...
        <Quadrant
          ...
          icon={
            <span className="w-10 h-10 rounded-2xl bg-gray-200 dark:bg-gray-700/50 flex items-center justify-center text-gray-600 dark:text-gray-300 shadow-sm">
