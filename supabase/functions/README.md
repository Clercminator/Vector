...
| `lemonsqueezy-checkout`       | Creates Lemon Squeezy checkout for US/EU users                                          | `LEMONSQUEEZY_API_KEY`, `LEMONSQUEEZY_STORE_ID`, `LEMONSQUEEZY_VARIANT_STANDARD`, `LEMONSQUEEZY_VARIANT_MAX`, optional `LEMONSQUEEZY_API_KEY_TESTING`, optional `LEMONSQUEEZY_STORE_ID_TESTING`, optional `LEMONSQUEEZY_VARIANT_BUILDER_TESTING`, optional `LEMONSQUEEZY_VARIANT_MAX_TESTING` |
