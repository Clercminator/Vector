  ...
  const handleExtraCreditPackCheckout = async (
    ...
    try {
      ...
      await createCheckout(supabase, {
        ...
        backUrlSuccess: `${window.location.origin}/profile?payment=success&purchase=extra_credits`,
        backUrlFailure: `${window.location.origin}/profile?payment=failure&purchase=extra_credits`,
        backUrlPending: `${window.location.origin}/profile?payment=pending&purchase=extra_credits`,
      });
    } catch (e) {
      console.error(e);
      toast.error(t("common.error") || "Failed to initiate checkout.");
                    ...
                    {EXTRA_CREDIT_PACKS.map((pack) => {
                      ...
                      return (
                        <Button
                          ...
                          onClick={() => handleExtraCreditPackCheckout(pack.id)}
                    ...
                    <Input
                      ...
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                        ...
                        if (!e.target.value || (val >= 10 && val <= 90)) {
                          setData({
                            ...data,
                            metadata: { ...data.metadata, age: e.target.value },
                          });
                        }
                      }}
                      placeholder="28"
                  ...
                  <div className="space-y-2 min-w-0">
                    ...
                    >
                      <SelectTrigger className="bg-transparent dark:text-white dark:border-zinc-700">
                        <SelectValue
                          placeholder={
                            t("profile.countryPlaceholder") || "Select country"
                          }
                        />
                      </SelectTrigger>
                  ...
                  <div className="space-y-2 min-w-0">
                    ...
                    >
                      <SelectTrigger className="bg-transparent dark:text-white dark:border-zinc-700">
                        <SelectValue
                          placeholder={
                            t("profile.zodiacImportancePlaceholder") || "Select"
                          }
                        />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setData({
                        ...data,
                        metadata: { ...data.metadata, skills: e.target.value },
                      })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setData({
                        ...data,
                        metadata: { ...data.metadata, hobbies: e.target.value },
                      })
                    }
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(val: string) =>
                          setData({
                            ...data,
                            metadata: { ...data.metadata, question_flow: val },
                          })
                        }
                      >
                        <SelectTrigger className="bg-transparent dark:text-white dark:border-zinc-700">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(val: string) =>
                          setData({
                            ...data,
                            metadata: { ...data.metadata, preferred_tone: val },
                          })
                        }
                      >
                        <SelectTrigger className="bg-transparent dark:text-white dark:border-zinc-700">
                          <SelectValue
                            placeholder={t("profile.preferredTonePlaceholder")}
                          />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className="bg-transparent dark:text-white dark:border-zinc-700">
                          <SelectValue
                            placeholder={t("profile.treatmentLevelPlaceholder")}
                          />
                        </SelectTrigger>
                        <SelectContent>
              ...
              <CollapsibleContent>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          checked={
                            data.metadata?.tracker_preferences?.show_streaks ??
                            true
                          }
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          checked={
                            data.metadata?.tracker_preferences?.show_heatmap ??
                            true
                          }
                          onCheckedChange={(c: boolean) =>
                            setData({
                      ...
                      <div className="space-y-2 pt-2">
                        ...
                        <Select
                          value={
                            data.metadata?.tracker_preferences?.default_view ||
                            "grid"
                          }
                ...
                <div className="mt-8">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                    Export all your blueprints, trackers, logs, and sub-goals as
                    a JSON file.
                  </p>
                  <Button
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <div className="capitalize font-medium text-black dark:text-white">
                                {t(`profile.provider.${provider}`) || provider}
                              </div>
                              {isLinked && (
                            ...
                            {isLinked ? (
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  identityId && handleUnlinkAccount(identityId)
                                }
