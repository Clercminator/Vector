...
export const WizardHeader: React.FC<WizardHeaderProps> = ({
  ...
  return (
    <div
      ...
      className="w-full max-w-full mx-auto flex-none pt-4 px-4 md:px-8 flex justify-between items-center bg-transparent z-20"
    >
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="hidden md:inline">
            {t("wizard.newConversation") || "New Conversation"}
          </span>
